...
public class BallState {
    ...
    public static final int MOVEMENT_HEIGHT = (Game.HEIGHT / 2) - 2 * RADIUS;
    public static final int MOVEMENT_WIDTH = (Game.WIDTH / 2) - 2 * RADIUS;
    ...
    public int[] getPositionAt(long when, GamePhase phase) {
        ...
        double halfWidth = MOVEMENT_WIDTH;
        double halfHeight = MOVEMENT_HEIGHT;
        ...
        double y = (Math.signum(rad)) * (legY + position) + halfHeight;
